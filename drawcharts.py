...
ax1.plot(df['date'],df['UPB'],color='#95aa00',linewidth='2',label='UPB')
#--range both axes 
ax1.set_ylim(0,2500)
...
ax1.legend(handles,labels,loc="upper center",
             ncol=4,bbox_to_anchor=(0.5,-0.25),frameon=False,prop={'size': 7},handlelength=4)
plt.tight_layout()
plt.title('Chart Title 1', fontsize=12,pad=20)
plt.show()
...
ax1.legend(handles,labels,loc="upper center",
             ncol=4,bbox_to_anchor=(0.5,-0.25),frameon=False,prop={'size': 7},handlelength=4)
plt.tight_layout()
plt.title('Chart Title 2', fontsize=12,pad=20)
...
plt.plot(df['fctrdt'],df['All'],color='#95daf3',linestyle=':',label="All")
plt.plot(df['fctrdt'],df['VA'],color='#96a816',label="VA")
plt.plot(df['fctrdt'],df['FHA'],color='#238ace',label="FHA")
...
plt.legend(handles,labels,loc="upper center",
             ncol=3,bbox_to_anchor=(0.5,-0.25),frameon=False,prop={'size': 9},handlelength=5)
...
plt.tick_params(axis=u'both',which=u'both',length=0,pad=10,labelsize=7)  
...
plt.title('Chart Title 3', fontsize=12,pad=20)
plt.tight_layout()
...
ax1.set_title('Chart Title 4', fontsize=7.2,pad=20)
ax1.set_axisbelow(True)
...
ax1.tick_params(axis=u'both',which=u'both',length=0,pad=10,labelsize=6) 
ax1.set_axisbelow(True)
plt.title('TOP 5 Servicers(%)', fontsize=7.2,pad=20,)
plt.tight_layout()
plt.show()
...
plt.title('Chart Title 6', fontsize=7.2,pad=20)
plt.tight_layout()
...
#--remove ticks from both axes
plt.tick_params(axis=u'both',which=u'both',length=0,pad=10,labelsize=6) 
plt.title('Chart Title 7', fontsize=12,pad=20)
plt.tight_layout()
...
fig = plt.figure(linewidth=2, edgecolor="#04253a",frameon=True)
ax1 = plt.subplot()

ax1.set_xlabel('Date')
ax1.set_ylabel('%yield')
l1 = ax1.plot(df['cpn_date'],df['G2SF CC % yield'],color='#2fa7e4',label="G2SF CC % yield",linewidth=2)
ax1.set_ylim(0,4.5)
ax1.tick_params(axis=u'both',which=u'both',length=0,pad=5,labelsize=7)
...
ax2.legend(line1+line2, label1+label2,loc="lower center", bbox_to_anchor=(0.5, -0.4)
...
plt.title('Chart Title 8', fontsize=12,pad=20)
plt.tight_layout()
...
ax1.plot(df['fctrdt'],df[df.columns[1]],color='#a6e1f5',linestyle=':',label="3")
ax1.plot(df['fctrdt'],df[df.columns[2]],color='#2fa7e4',label="3.5")
ax1.plot(df['fctrdt'],df[df.columns[3]],color='#2389ce',label="4")
ax1.plot(df['fctrdt'],df[df.columns[4]],color='#96a916',label="4.5")
...
ax1.legend(line1, label1,loc="lower center", bbox_to_anchor=(0.5, -0.3)
                ,columnspacing=2.5, ncol=4,frameon=False,prop={'size': 9},handlelength=5)

ax1.set_xlim(left=df['fctrdt'][0])

plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 9', fontsize=12)
plt.tight_layout()
...
plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 10', fontsize=12)
plt.tight_layout()
...
fig = plt.figure(linewidth=1, edgecolor="#04253a")
ax1 = plt.subplot()
ax1.plot(df['fctrdt'],df[df.columns[1]],color='#2389ce',linewidth=3,label="FHL")
ax1.plot(df['fctrdt'],df[df.columns[2]],color='#96a916',linewidth=3,label="FNM")
ax1.plot(df['fctrdt'],df[df.columns[3]],color='#a5a5a5',linewidth=3,label="GNM")
ax1.tick_params(axis=u'both',which=u'both',length=0,pad=5,labelsize=7)
...
plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 11', fontsize=12)
plt.tight_layout()
...
plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 12', fontsize=12)
plt.tight_layout()
...
fig = plt.figure(linewidth=1, edgecolor="#04253a")
ax1 = plt.subplot()
ax1.plot(df['fctrdt'],df[df.columns[1]],color='#2389ce',linewidth=3,label="FHA")
ax1.plot(df['fctrdt'],df[df.columns[2]],color='#96a916',linewidth=3,label="VA")
...
plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 13', fontsize=12,pad=20)
plt.tight_layout()
...
fig = plt.figure(linewidth=1, edgecolor="#04253a")
ax1 = plt.subplot()
ax1.plot(df['fctrdt'],df[df.columns[1]],color='#2389ce',linewidth=3,label="FHA Jumbo %")
ax1.plot(df['fctrdt'],df[df.columns[2]],color='#96a916',linewidth=3,label="VA Jumbo %")
ax1.plot(df['fctrdt'],df[df.columns[3]],color='#2fa7e4',linewidth=3,linestyle=':',label="Total Jumbo %")
ax1.tick_params(axis=u'both',which=u'both',length=0,pad=5,labelsize=7)
ax1.set_xticks(df['fctrdt'])
ax1.set_ylim(0,14)
ax1.spines['top'].set_visible(False)
...
plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 14', fontsize=12,pad=20)
plt.tight_layout()
...
ax1 = plt.subplot()
ax1.plot(df['fctrdt'],df[df.columns[1]],color='#104d73',linewidth=3,label="% LTV>90")
ax1.plot(df['fctrdt'],df[df.columns[2]],color='#2fa7e4',linewidth=3,label="% LTV>90")
ax1.plot(df['fctrdt'],df[df.columns[3]],color='#2389ce',linewidth=3,label="% LTV>90")
ax1.tick_params(axis=u'both',which=u'both',length=0,pad=5,labelsize=7)
ax1.set_xticks(df['fctrdt'][::2])
ax1.set_ylim(0,80)
ax1.spines['top'].set_visible(False)
...
plt.title('Chart Title 15', fontsize=12,pad=20)
plt.tight_layout()
...
ax1 = plt.subplot()
ax1.plot(df['fctrdt'],df[df.columns[1]],color='#95dbf3',linewidth=3,label="GSE avg cs")
ax1.plot(df['fctrdt'],df[df.columns[2]],color='#ffc000',linewidth=3,label="GSE median cs")
ax1.plot(df['fctrdt'],df[df.columns[3]],color='#104d73',linewidth=3,label="FHA avg cs")
ax1.plot(df['fctrdt'],df[df.columns[4]],color='#2fa7e4',linewidth=3,label="FHA median cs")
ax1.plot(df['fctrdt'],df[df.columns[5]],color='#96a916',linewidth=3,label="VA avg cs")
ax1.plot(df['fctrdt'],df[df.columns[6]],color='#56bff0',linewidth=3,label="VA median cs")
ax1.tick_params(axis=u'both',which=u'both',length=0,pad=5,labelsize=7)
ax1.set_xticks(df['fctrdt'][::2])
...
plt.title('Chart Title 16', fontsize=12,pad=20)
plt.tight_layout()
...
ax1.legend(reversed(line1), reversed(label1),loc="lower center", bbox_to_anchor=(1.1, 0.4)
                ,columnspacing=0.5, ncol=1,frameon=False,prop={'size': 7},handlelength=1)
plt.subplot().get_yaxis().set_major_formatter(
    mpl.ticker.FuncFormatter(lambda x, p: format(int(x), ',')))

plt.grid(axis='y',color="#f2f2f2",b=None,zorder=0)
plt.title('Chart Title 17', fontsize=12,pad=20)
plt.tight_layout()
...
ax1.legend(reversed(line1), reversed(label1),loc="lower center", bbox_to_anchor=(1.1, 0.5)
                ,columnspacing=0.5, ncol=1,frameon=False,prop={'size': 9},handlelength=1)
plt.subplot().get_yaxis().set_major_formatter(
    mpl.ticker.FuncFormatter(lambda x, p: format(int(x), ',')))

plt.grid(axis='y',color="#f2f2f2",b=None,zorder=0)
plt.title('Chart Title 18', fontsize=12,pad=20)
plt.tight_layout()
...
fig = plt.figure(linewidth=1, edgecolor="#04253a")
ax1 = plt.subplot()
ax1.plot(df['fctrdt'],df[df.columns[1]],color='#95dbf3',linewidth=3,label="All")
ax1.plot(df['fctrdt'],df[df.columns[2]],color='#ffc000',linewidth=3,label="Bank")
ax1.plot(df['fctrdt'],df[df.columns[3]],color='#104d73',linewidth=3,label="Non Bank")
...
line1,label1 = ax1.get_legend_handles_labels()
ax1.legend(line1, label1,loc="lower center", bbox_to_anchor=(0.5, -0.4)
                ,columnspacing=2.5, ncol=3,frameon=False,prop={'size': 9},handlelength=5)
plt.subplot().get_yaxis().set_major_formatter(
    mpl.ticker.FuncFormatter(lambda x, p: format(int(x), ',')))

plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 19', fontsize=12,pad=20)
plt.tight_layout()
...
plt.grid(axis='y',color="#f2f2f2")
plt.title('Chart Title 20', fontsize=12,pad=20)
plt.tight_layout()
...
plt.grid(axis='y',color="#f2f2f2",b=None,zorder=0)
plt.title('Chart Title 21', fontsize=12,pad=20)
plt.tight_layout()
...
plt.grid(axis='y',color="#f2f2f2",b=None,zorder=0)
plt.title('Chart Title 22', fontsize=12,pad=20)
plt.tight_layout()
...
fig = plt.figure(linewidth=2, edgecolor="#04253a",frameon=True,figsize=(18,4.5))
ax1 = plt.subplot()
ax1.set_xlabel('Date')
ax1.set_ylabel('$m')
l1 = ax1.plot(df['fctrdt'],df[df.columns[1]],color='#95daf3',label="Issuance(left)",linewidth=3)
l2 = ax1.plot(df['fctrdt'],df[df.columns[2]],color='#2389ce',label="Mandatory Purchase(right)",linewidth=3)
ax1.set_ylim(0,1601)
...
l3 = ax2.plot(df['fctrdt'],df[df.columns[3]],
    color='#96a916',label="HECM UPB(right)",linewidth=2)
...
ax2.legend(line1+line2, label1+label2,loc="lower center", bbox_to_anchor=(0.5, -0.5)
                ,columnspacing=2.5, ncol=3,frameon=False,prop={'size': 9},handlelength=7)

plt.title('Chart Title 23', fontsize=12,pad=20)
...
plt.title('Chart Title 24', fontsize=12,pad=20,zorder=0)
plt.tight_layout()
...
plt.title('Chart Title 25', fontsize=12,pad=20)
plt.tight_layout()
